...
function buildResponseComposerPrompt(input: ComposeBotResponseInput) {
  ...
  return [
    ...
    "- Sempre deixe explicito o recorte consultado quando houver filtro de periodo, animal, categoria ou pessoa em resultado.filters. Um resumo deve dizer de que periodo ele e, por exemplo \"Resumo financeiro de agosto de 2026\", nunca apenas \"Resumo financeiro\". Assim o usuario percebe na hora se o bot entendeu o periodo errado.",
